...
# Função para definir o fundo da célula e aplicar bordas pretas
def set_cell_background_and_borders(cell, color, border_size):
    """Define o fundo branco e aplica bordas pretas na célula."""
    tc = cell._element
    ...
    # Define bordas pretas de 0,5 pt
    for border_type in ['top', 'left', 'bottom', 'right']:
        tc_borders = OxmlElement(f'w:{border_type}')
        tc_borders.set(qn('w:val'), 'single')
        tc_borders.set(qn('w:sz'), str(border_size))  # Tamanho da linha (0,5 pt = 4 em OOXML units)
...
def create_vpn_doc(users_passwords):
    ...
    for i, (user, password) in enumerate(users_passwords):
        ...
        set_cell_background_and_borders(title_cell, 'FFFFFF', 4)  # Fundo branco, bordas pretas 0,5 pt
        ...
        run1.font.bold = True
        set_cell_background_and_borders(cell1, 'FFFFFF', 4)  # Fundo branco, bordas pretas 0,5 pt

        cell2 = table.cell(1, 1)
        run2 = cell2.paragraphs[0].add_run('Open VPN')
        run2.font.name = 'Calibri'
        run2.font.size = Pt(11)
        set_cell_background_and_borders(cell2, 'FFFFFF', 4)  # Fundo branco, bordas pretas 0,5 pt
        ...
        run3.font.bold = True
        set_cell_background_and_borders(cell3, 'FFFFFF', 4)  # Fundo branco, bordas pretas 0,5 pt

        cell4 = table.cell(2, 1)
        run4 = cell4.paragraphs[0].add_run(user)
        run4.font.name = 'Calibri'
        run4.font.size = Pt(11)
        set_cell_background_and_borders(cell4, 'FFFFFF', 4)  # Fundo branco, bordas pretas 0,5 pt
        ...
        run5.font.bold = True
        set_cell_background_and_borders(cell5, 'FFFFFF', 4)  # Fundo branco, bordas pretas 0,5 pt
        ...
        set_cell_background_and_borders(cell6, 'FFFFFF', 4)  # Fundo branco, bordas pretas 0,5 pt
