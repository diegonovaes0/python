...
# Função para aplicar indentação de 2 espaços no início de cada linha
def apply_indentation(paragraph):
    """Aplica uma indentação de 0,3 cm (aproximadamente 2 espaços) no início da linha."""
    paragraph.paragraph_format.first_line_indent = Cm(0.3)  # Aproximadamente 2 espaços
