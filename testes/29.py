...
def display_document_content():
    ...
    # Frame principal para o scroll e canvas
    main_frame = tk.Frame(root, bg="white")
    main_frame.pack(fill="both", expand=True)

    # Canvas e Scrollbar para rolagem
    canvas = tk.Canvas(main_frame, bg="white", width=780, height=850)
    ...
    # Exibe as imagens e o conteúdo de texto
    ...
    for paragraph in text_content:
        text_label = tk.Label(scrollable_frame, text=paragraph, wraplength=750, justify="left", anchor="w", font=("Helvetica", 12), bg="white")
    ...
    # Exibição do Canvas e Scrollbar
