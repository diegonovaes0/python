...
def exibir_projetos():
    ...
    for i, projeto in enumerate(clientes):
        ...
        botao_excluir.grid(row=0, column=4, padx=2)
...
botao_salvar.pack(side="bottom", pady=5)

botao_carregar = tk.Button(root, text="Carregar JSON", command=carregar_json, bg="lightblue")
botao_carregar.pack(side="bottom", pady=5)
